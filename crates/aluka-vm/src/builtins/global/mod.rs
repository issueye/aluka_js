...
fn build(vm: &mut Vm, registry: &mut BuiltinRegistry) -> Result<ObjectRef, VmError> {
    ...
    registry
        .dispatch
        .insert("fetch".to_owned(), fetch::global_fetch);
    ...
    registry.dispatch.insert(
        ...
        abort::abort_controller_ctor_impl,
    );
    register_handler(
        registry,
        "AbortController",
        "abort",
        abort::controller_abort_impl,
    );
    register_handler(
        registry,
        "AbortSignal",
        "abort",
        abort::abort_signal_abort_dispatch,
    );
    register_handler(
        registry,
        "AbortSignal",
        "throwIfAborted",
        abort::signal_throw_if_aborted,
    );
    ...
    let _ = vm.set_property(
        Value::Object(asig_ctor),
        "prototype",
        Value::Object(asig_proto),
    );
    ...
    vm.globals
        .insert("AbortSignal".to_owned(), Value::Object(asig_ctor));
    registry
        .dispatch
        .insert("AbortSignal".to_owned(), abort::abort_signal_ctor_impl);
    register_handler(
        registry,
        "AbortSignal",
        "addEventListener",
        abort::signal_add_event_listener,
    );
    register_handler(
        registry,
        "AbortSignal",
        "removeEventListener",
        abort::signal_remove_event_listener,
    );
    ...
    registry
        .dispatch
        .insert("Headers".to_owned(), headers::headers_ctor_impl);
    ...
    register_handler(
        ...
        "Response",
        "arrayBuffer",
        fetch::response_array_buffer_handler,
    );
    register_handler(
        registry,
        "Response",
        "formData",
        form_data::response_form_data_handler,
    );
    ...
    let _ = vm.set_property(
        Value::Object(resp_ctor),
        "prototype",
        Value::Object(resp_proto),
    );
    ...
    vm.globals
        .insert("Response".to_owned(), Value::Object(resp_ctor));
    registry
        .dispatch
        .insert("Response".to_owned(), fetch::response_ctor_impl);
    register_handler(
        registry,
        "Response",
        "redirect",
        fetch::response_static_redirect,
    );
    ...
    registry
        .dispatch
        .insert("Request".to_owned(), fetch::request_ctor_impl);
    ...
    vm.globals
        .insert("URLSearchParams".to_owned(), Value::Object(usp_ctor));
    registry
        .dispatch
    ...
    vm.globals
        .insert("TextEncoder".to_owned(), Value::Object(te_ctor));
    registry
        .dispatch
        .insert("TextEncoder".to_owned(), web::text_encoder_ctor);
    register_handler(registry, "TextEncoder", "encode", web::text_encoder_encode);

    let td_ctor = vm.alloc_native_ctor("TextDecoder", None);
    vm.globals
        .insert("TextDecoder".to_owned(), Value::Object(td_ctor));
    registry
        .dispatch
    ...
    vm.globals.insert(
        "ByteLengthQueuingStrategy".to_owned(),
        Value::Object(bq_ctor),
    );
    registry.dispatch.insert(
        "ByteLengthQueuingStrategy".to_owned(),
        web::queuing_strategy_ctor,
    );
    let cq_ctor = vm.alloc_native_ctor("CountQueuingStrategy", None);
    vm.globals
        .insert("CountQueuingStrategy".to_owned(), Value::Object(cq_ctor));
    registry.dispatch.insert(
        "CountQueuingStrategy".to_owned(),
        web::queuing_strategy_ctor,
    );
    register_handler(
        registry,
    ...
    vm.globals
        .insert("Blob".to_owned(), Value::Object(blob_ctor));
    registry
        .dispatch
        .insert("Blob".to_owned(), web::blob_ctor_impl);
    ...
    registry
        .dispatch
        .insert("EventTarget".to_owned(), event::event_target_ctor_impl);
    for method in ["addEventListener", "removeEventListener", "dispatchEvent"] {
        register_handler(
            registry,
            "EventTarget",
            method,
            event::event_target_dispatch,
        );
    }

    let ev_ctor = vm.alloc_native_ctor("Event", None);
    vm.globals
        .insert("Event".to_owned(), Value::Object(ev_ctor));
    registry
        .dispatch
        .insert("Event".to_owned(), event::event_ctor_impl);
    register_handler(
        registry,
        "Event",
        "preventDefault",
    ...
    registry
        .dispatch
        .insert("CustomEvent".to_owned(), event::custom_event_ctor_impl);
    ...
    registry
        .dispatch
        .insert("FormData".to_owned(), form_data::form_data_ctor_impl);
    for method in [
    ...
    for (name, handler) in [
        (
            "ReadableStream",
            crate::builtins::stream_web::readable_stream_ctor as BuiltinHandler,
        ),
        (
            "WritableStream",
            crate::builtins::stream_web::writable_stream_ctor as BuiltinHandler,
        ),
        (
            "TransformStream",
            crate::builtins::stream_web::transform_stream_ctor as BuiltinHandler,
        ),
    ] {
